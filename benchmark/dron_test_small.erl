...
test_path() ->
  "/home/ionel/code/Dron/benchmark/".
...
grep_mapred() ->
  ...
  dron_api:register_job(
    #job{name = "GrepMR",
         cmd_line = "hadoop jar " ++ test_path() ++ "jars/benchmarks.jar Grep /input/grep/ /output/grep/ -m 4 -r 0 -Dmapreduce.grep.textfind=true -Dmapreduce.grep.pattern=XYZ -Dmapreduce.grep.match_group=-1;",
         start_time = StartTime,
         frequency = 0,
         timeout = 10000,
         max_retries = 1,
...
select_rank_mapred() ->
  ...
  dron_api:register_job(
    #job{name = "SelRankMR",
         cmd_line = "hadoop jar " ++ test_path() ++ "jars/benchmarks.jar Benchmark1 /input/rankings/ /output/rankings/ -m 1 -r 1 -Dmapreduce.minpagerank=10",
         start_time = StartTime,
         frequency = 0,
         timeout = 10000,
         max_retries = 1,
...
agg_uv_mapred() ->
  ...
  dron_api:register_job(
    #job{name = "AggUVMR",
         cmd_line = "hadoop jar " ++ test_path() ++ "jars/benchmarks.jar Benchmark2 /input/uservisits/ /output/uservisits_agg/ -m 6 -r 1",
         start_time = StartTime,
         frequency = 0,
         timeout = 10000,
         max_retries = 1,
...
join_uv_mapred() ->
  ...
  dron_api:register_job(
    #job{name = "JoinUVMR",
         cmd_line = "hadoop jar " ++ test_path() ++ "jars/benchmarks.jar Benchmark3 /input/uservisits /input/rankings/ /output/uservisits_join/ -m 6 -r 1 -Dmapreduce.startdate=1999-01-01 -Dmapreduce.stopdate=2001-01-01",
         start_time = StartTime,
         frequency = 0,
         timeout = 10000,
         max_retries = 1,
...
create_grep() ->
  ...
  dron_api:register_job(
    #job{name = "CreateGrep",
         cmd_line = "hadoop jar \"$HADOOP_HOME\"/hadoop-examples.jar teragen 10000 /input/grep",
         start_time = StartTime,
         frequency = 0,
         timeout = 10000,
         max_retries = 1,
